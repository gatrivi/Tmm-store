...
export const socialPages = [
  ...
  page('el-mirasol', ['/el-mirasol', '/demo/el-mirasol'], 'El Mirasol de La Recova — demo de carta para parrilla', 'Picadas, parrilla, achuras y combos para 2 o 4 en una carta propia para el celular, sin comisión por venta.', '/og/demo-el-mirasol.png', { canonicalPath: '/el-mirasol', robots: 'noindex, follow' }),
