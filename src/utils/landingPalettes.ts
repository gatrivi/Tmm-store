...
const BASE_LIGHT = {
  ...
  '--lp-border': 'rgba(23, 24, 20, 0.1)',
  '--lp-footer': '#10110e',
  '--lp-on-ink': '#ffffff',
  '--lp-panel': '#171814',
  '--lp-on-panel': '#ffffff',
  '--lp-header-bg': 'rgba(242, 238, 230, 0.92)',
  '--lp-glow': 'rgba(238, 104, 71, 0.18)',
  '--lp-glow-2': 'rgba(215, 255, 100, 0.16)',
};

const BASE_DARK = {
  '--lp-bg': '#0b0c0a',
  '--lp-surface': '#161814',
  '--lp-surface-alt': '#1e201b',
  '--lp-ink': '#f3f0e8',
  '--lp-text': '#f3f0e8',
  '--lp-text-muted': 'rgba(243, 240, 232, 0.64)',
  '--lp-border': 'rgba(255, 255, 255, 0.14)',
  '--lp-footer': '#070806',
  '--lp-on-ink': '#0b0c0a',
  '--lp-panel': '#12140f',
  '--lp-on-panel': '#f3f0e8',
  '--lp-header-bg': 'rgba(11, 12, 10, 0.94)',
  '--lp-glow': 'rgba(255, 123, 92, 0.28)',
  '--lp-glow-2': 'rgba(215, 255, 100, 0.14)',
};
